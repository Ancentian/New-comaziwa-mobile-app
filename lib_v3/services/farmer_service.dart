...
class FarmerService {
  ...
  Future<String?> _getAuthToken() async {
    ...
    return prefs.getString('token') ?? prefs.getString('auth_token') ?? prefs.getString('access_token');
  }
  ...
  Future<bool> downloadFarmers() async {
    ...
    print('🔄 downloadFarmers called - token: ${token != null ? "exists" : "null"}, tenantId: $tenantId');
    ...
    try {
      ...
      print('🌐 Fetching farmers from: $url');
  ...
  Future<Farmer?> searchOnline(String memberNo) async {
    ...
    try {
      final url = Uri.parse("$apiBase/find-farmer/$memberNo?tenant_id=$tenantId");
