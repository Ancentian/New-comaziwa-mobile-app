...
Future<void> searchFarmer(String memberNo) async {
  ...
  Future<void> _autoPrintReceipt(MilkCollection collection) async {
    try {
      // Calculate today's and monthly totals for this farmer
      ...
      for (var record in box.values) {
        if (record.farmerId == collection.farmerId) {
          ...
          if (recordDate != null) {
            final recordTotal = record.morning + record.evening;
      ...
      final receiptData = {
        ...
        'total': (collection.morning + collection.evening).toString(),
            ...
            Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'e.g., 508',
                  prefixIcon: Icon(Icons.person_search, color: Colors.green.shade700),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.water_drop, color: Colors.green.shade700, size: 20),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.analytics_outlined, color: Colors.grey.shade700, size: 20),
                        const SizedBox(width: 8),
                        const Text(
                          'Your Statistics',
                          style: TextStyle(
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 12),
                        Expanded(child: _buildStatCard('This Month', monthlyTotal, Colors.blue)),
                      ],
                    ),
                  ],
                ),
  ...
  Widget _buildInput(TextEditingController controller, String label, {bool error = false, IconData? icon}) {
  return TextField(
    controller: controller,
    style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500),
    decoration: InputDecoration(
      labelText: label,
      prefixIcon: icon != null ? Icon(icon, color: error ? Colors.red : Colors.green.shade700, size: 20) : null,
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: error ? Colors.red : Colors.green.shade300),
      ),
      enabledBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: error ? Colors.red.shade300 : Colors.grey.shade300),
      ),
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(12),
        borderSide: BorderSide(color: error ? Colors.red : Colors.green.shade700, width: 2),
      ),
