...
class _FarmersListPageState extends State<FarmersListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Farmers List"), elevation: 1),
      body: Column(
        children: [
            ...
            child: isLoading && farmers.isEmpty
                ...
                ? Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          isOnline
                              ? 'Try syncing farmers from settings'
                              : 'You are offline',
                          style: TextStyle(
                            fontSize: 14,
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      // Log the farmerId when rendering each ListTile
                      print('Rendering farmer with ID: \\${farmer.farmerId}');
